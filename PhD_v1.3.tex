...
The dispersion relation does not influence the element of volume $dV_k$, thus the DOS function per unit energy for linear bands for 3, 2, and 1 dimensions:
\begin{eqnarray}
\label{eq:DOS_lin4}
...
The most interesting region of the whole electromagnetic spectrum, considering this thesis, is the THz region. In general the THz region spans over the frequency domain between 0.3 THz to 30 THz. According to generally accepted convention, THz range overlaps with both FIR and mid-infrared regions. An adjacent region of radiation, with lower energies than FIR, is called microwaves. 
